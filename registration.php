     ...
     <?php
          ...
          if(isset($_POST['submit']))
          {
            ...
            if(isset($_POST['address'])){
              ...
              if(strlen($_POST['address']) <= 256)
                  $address =str_ireplace($sql_keywords, $sql_replace, htmlentities(strip_tags(trim($_POST['address']), ENT_NOQUOTES)));

            }
            if(preg_match($reg_code, $_POST['code']))
            ...
            if(isset($_POST['bio'])){
                   $bio =str_ireplace($sql_keywords, $sql_replace,  htmlentities(strip_tags(trim($_POST['bio']), ENT_NOQUOTES)));
            ...
            $sql = "insert into usertable (UserName, EmailAddress, Address, PostalCode, PhoneNumber, UserBIO)
